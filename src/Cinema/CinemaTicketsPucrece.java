...
public class CinemaTicketsPucrece {
    private final int rows;
    private final int cols;
    private final String[][] seats;

    private CinemaTicketsPucrece(int rows, int cols) {
        this.rows = rows;
        this.cols = cols;
    ...
    private static CinemaTicketsPucrece readCinema() {
        Scanner scanner = new Scanner(System.in);
        ...
        return new CinemaTicketsPucrece(rows, cols);
    }

    public static void main(String[] args) {
        CinemaTicketsPucrece cinema = readCinema();
        cinema.showMenu();
    }
