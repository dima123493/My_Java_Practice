...
public class FunctionalManager {
    ...
    public FunctionalManager(int numberOfQueues) {
        if (numberOfQueues < 1) {
    ...
    public Supplier<Task> getTaskSupplier() {
        //return taskQueues.stream().filter(a -> a.isEmpty()).findFirst().get();
        return null;
    }
}
...
class TasksHandling {
    ...
    public static void main(String[] args) {
        ...
        FunctionalManager manager = new FunctionalManager(numberOfQueues);
